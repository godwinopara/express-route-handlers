...
exports.getAlbumsForLatestArtist = () => {
  ...
  const artistAlbums = Object.values(albums).filter((album) => album.artistId == latestArtist.artistId);
  return {
    latest: {
      albums: artistAlbums,
    },
...
exports.getFilteredAlbums = (startsWith) => {
  ...
  return Object.values(albums).filter((album) => album.name.startsWith(startsWith));
};
...
exports.getSongBySongId = (songId) => {
  ...
  song.album = Object.values(albums).find((album) => album.albumId == song.albumId);
